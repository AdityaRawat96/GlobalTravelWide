...
var myDropzone;
var KTExpenseSettings = (function () {
    var t, n, r;
    return {
        init: function () {
            (r = document.querySelector("#kt_create_form")),
                ...
                $(document).ready(function (e) {
                    $("#amount").change(function () {
                        KTExpenseSettings.formatAmount();
                    });
                    ...
                    $(".reset").on("click", function (e) {
                        ...
                        $("#kt_create_form").on("submit", function (e) {
                            ...
                            var expense_date = formData.get("date");
        ...
        formatAmount: function () {
            var numb = wNumb({ decimals: 2, thousand: "," });
            var amount = $("#amount");
            var r = numb.from(amount.val());
            r = !r || r < 0 ? 0 : r;
            amount.val(numb.to(r));
        },
    };
})();
KTUtil.onDOMContentLoaded(function () {
    KTExpenseSettings.init();
    KTExpenseSettings.initializeDropZone();
    KTExpenseSettings.formatAmount();
});
