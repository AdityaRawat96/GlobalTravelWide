...
var KTDatatablesServerSide = (function () {
    ...
    var filter = (filter = {
        ...
        commission_calculation: server_commissionCalculation
            ? server_commissionCalculation
            : "invoice_date",
    });
    ...
    var initDatatable = function () {
        dt = $("#kt_datatable").DataTable({
            ...
            stateSave: false,
            ajax: {
                url: `${siteURL}/${siteUserRole}/commission/${commissionAffiliateId}`,
                data: function (d) {
                    d.filter = filter;
                },
    ...
    var initFilter = () => {
        $(".commission_calculation")
            .val(server_commissionCalculation)
            .trigger("change");
    ...
    var handleFilterDatatable = () => {
        ...
        $(".datetimepicker-input").change(
            ...
            function (ev, picker) {
                ...
                filter = {
                    ...
                    commission_calculation: $(".commission_calculation").val(),
                };
                dt.ajax.reload();
            }
        );
        ...
        clearFilterButton.addEventListener("click", function () {
            ...
            $(".commission_calculation").val("invoice_date").trigger("change");
            dt.ajax.reload();
        });
    };
    ...
    var handleExportDatatable = () => {
        $(".menu-link-export").click(function (e) {
            ...
            hiddenField.setAttribute("name", "affiliate_id");
            hiddenField.setAttribute("value", commissionAffiliateId);
            form.appendChild(hiddenField);

            hiddenField = document.createElement("input");
            hiddenField.setAttribute("type", "hidden");
            hiddenField.setAttribute("name", "commission_calculation");
            hiddenField.setAttribute(
                "value",
                $(".commission_calculation").val()
            );
            form.appendChild(hiddenField);
