...
var KTDatatablesServerSide = (function () {
    ...
    var filter = (filter = {
        ...
        commission_calculation: "invoice_date",
    });
    ...
    var initDatatable = function () {
        dt = $("#kt_datatable").DataTable({
            ...
            stateSave: false,
            ajax: {
                url: `${siteURL}/${siteUserRole}/commission`,
                data: function (d) {
                    d.filter = filter;
                },
...
function viewCommission(url) {
    var date_range = $(".datetimepicker-input").val().split(" - ");
    $("#view_form").attr("action", url);
    $("#affiliate_id_field").val($("#affiliate_id").val());
    $("#commission_calculation_field").val($(".commission_calculation").val());
