    ...
    init: function () {
      ...
      (o = document.querySelector('#kt_ecommerce_add_product_discount_slider')),
        ...
        o.noUiSlider.on('update', function (e, t) {
          $("input[name='dicsounted_price_percentage']").val(Math.round(e[t])),
        ...
        (() => {
          ...
          (e = FormValidation.formValidation(t, {
            fields: {
              ...
              asin: {
                validators: { notEmpty: { message: 'ASIN is required' } },
              },
              price: {
                validators: {
              ...
              items: {
                validators: {
                  notEmpty: { message: 'Number of items is required' },
                  digits: { message: 'Number of items must be a number' },
                },
              },
              weight: {
                validators: {
              ...
              product_width: {
                validators: {
                  notEmpty: { message: 'Product width is required' },
                },
              },
              product_height: {
                validators: {
                  notEmpty: { message: 'Product height is required' },
                },
              },
              product_length: {
                validators: {
                  notEmpty: { message: 'Product length is required' },
                },
              },
              tax: {
                validators: {
            ...
            $(document).ready(function (e) {
              $('#kt_ecommerce_add_product_form').on('submit', function (e) {
                ...
                $.ajax({
                  url: $('#kt_ecommerce_add_product_form').attr('action'),
                  type: $('#kt_ecommerce_add_product_form').attr('method'),
                  data: formData,
                  processData: false,
                  contentType: false,
                  cache: false,
