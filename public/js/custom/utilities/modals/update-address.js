...
var KTModalUpdateAddress = (function () {
  ...
  return {
    init: function () {
      (r = document.querySelector('#kt_modal_update_address')) &&
        ((i = new bootstrap.Modal(r)),
        (o = document.querySelector('#kt_modal_update_address_form')),
        (t = document.getElementById('kt_modal_update_address_submit')),
        (e = document.getElementById('kt_modal_update_address_cancel')),
                ...
                console.log('validated!'),
                  'Valid' == e
                    ? (t.setAttribute('data-kt-indicator', 'on'),
                      (t.disabled = !0),
                      $.ajax({
                        url: $('#kt_modal_update_address_form').attr('action'),
                        type: $('#kt_modal_update_address_form').attr('method'),
                        data: $('#kt_modal_update_address_form').serialize(),
