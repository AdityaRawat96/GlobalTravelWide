...
var FormSubmission = (function () {
    ...
    return {
        ...
        sanitizeFormData: function (formData) {
            formData.set("invoice_id", $("#invoice_id").val());

            // Parse dates to MySQL format
            var invoice_date = moment(
                formData.get("invoice_date"),
                "DD, MMM YYYY"
            );
            var mysqlDate = invoice_date.format("YYYY-MM-DD");
            ...
            var departure_date = moment(
                formData.get("departure_date"),
                "DD, MMM YYYY"
            );
            var mysqlDepartureDate = departure_date.format("YYYY-MM-DD");
            formData.set("departure_date", mysqlDepartureDate);
