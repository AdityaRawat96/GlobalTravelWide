...
<div class="d-flex flex-column flex-column-fluid">
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <!--begin::Form-->
            <form class="form d-flex flex-column flex-lg-row" action="{{route('user.product.store')}}"
                id="kt_ecommerce_add_product_form" method="POST" enctype="multipart/form-data"
                data-kt-redirect="{{route('user.product.index')}}">
                @csrf
                <!--begin::Aside column-->
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="d-none mt-10">
                                ...
                                <input class="form-control" id="kt_ecommerce_add_product_status_datepicker"
                                    placeholder="Pick date & time" name="scheduled" />
                            </div>
                            <!--end::Datepicker-->
                        </div>
                        <!--end::Card body-->
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="text-end mb-3">
                                            <button class="btn btn-primary"
                                                onclick="searchProduct(`{{route('user.product.searchProduct')}}`)"
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    ...
                                                    <div class="mb-10 fv-row">
                                                        ...
                                                        <input type="text" name="items" class="form-control mb-2"
                                                            placeholder="Number of items" value="" />
                                                        <!--end::Editor-->
                                                        <!--begin::Description-->
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <textarea name="kt_ecommerce_add_product_meta_description"
                                                class="form-control min-h-100px mb-2"></textarea>
                                            <!--end::Editor-->
                                            <!--begin::Description-->
                                    ...
                                    <div class="card-body pt-0">
                                                    ...
                                                    <label
                                                        ...
                                                        <span
                                                            ...
                                                            <input class="form-check-input" type="radio"
                                                                name="discount_option" value="none" checked="checked" />
                                                        </span>
                                                        <!--end::Radio-->
                                                        <!--begin::Info-->
                                                        <span class="ms-5">
                                        ...
                                        <div class="d-flex flex-wrap gap-5">
                                            ...
                                            <div class="fv-row w-100 flex-md-root">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" class="form-control mb-2" value="" name="vat" />
                                                <!--end::Input-->
                                                <!--begin::Description-->
                    ...
                    <div class="d-flex justify-content-end">
                        <!--begin::Button-->
                        <a href="{{route('user.product.index')}}" id="kt_ecommerce_add_product_cancel"
...
<script src="{{asset('js/custom/apps/product/create-product.js')}}"></script>
