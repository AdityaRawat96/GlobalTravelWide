                    ...
                    <div class="d-flex flex-stack mb-5 table-toolbar">
                        ...
                        <div class="table-search d-flex align-items-center position-relative my-1">
                            ...
                            <span class="svg-icon svg-icon-1 position-absolute ms-6">
                                <svg width="24" height="24" viewUser="0 0 24 24" fill="none"
                        ...
                        <div class="d-flex justify-content-end gap-2" data-kt-docs-table-toolbar="base">
                            ...
                            <div id="kt_datatable_export_menu"
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{route('admin.user.export', 'excel')}}" class="menu-link px-3"
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{route('admin.user.export', 'csv')}}" class="menu-link px-3"
                                        data-kt-export="csv">
                                        Export as CSV
                                    </a>
                                </div>
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{route('admin.user.export', 'pdf')}}" class="menu-link px-3"
                                        data-kt-export="pdf">
                                        Export as PDF
                                    </a>
                                </div>
