    ...
    <div class="stepper stepper-links d-flex flex-column " id="kt_create_account_stepper"
        ...
        <div class="form d-flex flex-column flex-lg-row">
            <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                @include('user.order.wizard-step.aside')</div>
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                <div>
                    @include('user.order.wizard-step.step0')
                    @include('user.order.wizard-step.step1')
                    @include('user.order.wizard-step.step2')
                    @include('user.order.wizard-step.step3')
                    @include('user.order.wizard-step.step4')
                    @include('user.order.wizard-step.step5')
                    @include('user.order.wizard-step.step6')
                    @include('user.order.wizard-step.step7')
                </div>
                ...
                <div class="d-flex flex-stack pt-10">
                    ...
                    <div>
                        <button type="button" class="btn btn-lg btn-primary order-continue-button"
                            ...
                            <span class="indicator-label">{{ $currentStep != 6 ? 'Continue' : 'Place Order'}}
