        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <h1 class="page-heading d-flex fw-bold fs-3 flex-column justify-content-center my-0">
                    {{ str_pad($pnr->id, 5, '0', STR_PAD_LEFT) }}
                </h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div class="content">
                    <!--begin::Form-->
                    <form class="form" action="{{isset($pnr) ? route(Auth::user()->role . '.pnr.update', $pnr->id) : route(Auth::user()->role . '.pnr.store')}}" id="kt_create_form" method="{{isset($pnr) ? 'PUT' : 'POST'}}">
                        @csrf
                        <!--begin::Card body-->
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <textarea name="notes" class="form-control form-control-lg form-control-solid" rows="3" placeholder="Description" disabled>{{isset($pnr->notes) ? $pnr->notes : null}}</textarea>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                        ...
                        <div class="card-footer d-flex justify-content-end py-6 px-9">
                            ...
                            <a href="{{route(Auth::user()->role . '.pnr.edit', $pnr->id)}}" class="btn btn-primary">Edit</a>
                        </div>
                        <!--end::Actions-->
                    </form>
                    <!--end::Form-->
...
<script src="{{asset('js/pnr/show.js')}}"></script>
