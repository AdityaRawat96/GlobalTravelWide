                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_products_table">
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            ...
                            <tr id="datatable-row-{{$index}}">
                                <form class="form update_shipment_form"
                                    action="{{route('admin.shipment.updateAdmin', $product->asin)}}" method="POST"
                                    id="update_shipment_form_{{$index}}" data-valid="true" data-index="{{$index}}">
                                    @csrf
                                    <!--begin::Category=-->
                                    <td>
                                    ...
                                    <td class="text-end">
                                        <span>
                                            <b id="product_total_{{$index}}">{{$product->total}}</b>
                                        </span><br>
                                        <span class="text-primary"
                                            id="product_working_{{$index}}">{{$product->working}}</span>
                                    </td>
                                    <td class="text-end" id="product_working_{{$index}}">
                                        {{$product->incoming}}
                                    </td>
                                    <!--end::Qty=-->
                                    <!--begin::received=-->
                                    <td class="text-end" data-order="{{$product->received}}">
                                        <!-- begin::Input group-->
                                        <div class="fv-row">
                                            <!--begin::Input-->
                                            <input type="text" name="customer_id" value="{{$customer_id}}" hidden>
                                            <input type="number"
                                                class="form-control form-control-solid product_received"
                                                id="product_received_{{$index}}" placeholder="" name="product_received"
                                                style="max-width: 150px" value="{{$product->received}}"
                                                data-index="{{$index}}" />
                                            <!--end::Input-->
                                        </div>
                                        <!-- end::Input group-->
                                    ...
                                    <!--end::received=-->
                                    <!--begin::damaged=-->
                                    <td class="text-end" data-order="{{$product->damaged}}">
                                        <!-- begin::Input group-->
                                        <div class="fv-row">
                                            <!--begin::Input-->
                                            <input type="number" class="form-control form-control-solid product_damaged"
                                                id="product_damaged_{{$index}}" placeholder="" name="product_damaged"
                                                style="max-width: 150px" value="{{$product->damaged}}"
                                                data-index="{{$index}}" />
                                            <!--end::Input-->
                                        </div>
                                        <!-- end::Input group-->
                                    ...
                                    <td class="text-end">
                                        <a href="#" class="menu-link px-3" data-bs-toggle="modal"
                                            data-bs-target="#kt_modal_view_shipment"
                                            onclick="viewShipmentHistoryAdmin(`{{route('admin.shipment.history', $product->asin)}}`, `{{$customer_id}}`)"
                                            data-kt-product-table-select="update_shipment"><i
                                                class="fas fa-list my-3"></i></a>
                                    </td>
                                    <!--begin::Action=-->
                                    <td class="text-end">
                                        <!--begin::Button-->
                                        <button type="submit" onclick="update_shipment_form_submit({{$index}})"
                                            class="btn btn-primary form-control" id="button_update_shipment_{{$index}}">
                                            <span class="indicator-label">Update</span>
                                            <span class="indicator-progress">
                                                <span
                                                    class="spinner-border spinner-border-sm align-middle ms-2 my-1"></span></span>
                                        </button>
                                        <!--end::Button-->
                                    </td>
                                    <!--end::Action=-->
...
<script src="{{asset('js/custom/apps/shipments/admin.js')}}"></script>
<script src="{{asset('js/custom/apps/shipments/update-shipment-admin.js')}}"></script>
