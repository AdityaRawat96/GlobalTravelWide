    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Inventory
                </h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt-customer-table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                <th class="max-w-100px">Customer ID</th>
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            ...
                            <tr id="datatable-row-{{$customer->id}}">
                                <td>
                                ...
                                <td class="text-end">
                                    <div class="d-flex justify-content-end flex-shrink-0">
                                        <a href="{{route('admin.inventory.view', $customer->id)}}"
...
<script src="{{asset('js/custom/apps/inventory/index.js')}}"></script>
