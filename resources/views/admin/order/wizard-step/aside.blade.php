             ...
             <div class="d-flex flex-column gap-10">
                 <div class="add-product-container">
                     ...
                     <div class="row my-5">
                         <div class="col-12">
                             <label>Price ($)</label>
                             <input class="form-control" type="text" wire:model="current_product.price">
                         </div>
                     </div>
                     ...
                     <div class="row mb-3">
                         <div class="col-4">
                             <label>Length</label>
                             <input class="form-control" type="text" wire:model="current_product.length">
                         </div>
                         <div class="col-4">
                             <label>Width.</label>
                             <input class="form-control" type="text" wire:model="current_product.width">
                         </div>
                         <div class="col-4">
                             <label>Height</label>
                             <input class="form-control" type="text" wire:model="current_product.height">
                         </div>
                     </div>
                     ...
                     <div class="row mb-3">
                         <div class="col-6">
                             ...
                             <input class="form-control" type="text" wire:model="current_product.a_weight">
                         </div>
                         <div class="col-6">
                             <label>Deci Wt.</label>
                             <input class="form-control" type="text" wire:model="current_product.d_weight">
                         </div>
                     </div>
                     ...
                     <div class="row mb-3">
                         <div class="col-12">
                             ...
                             <textarea class="form-control" rows="3" wire:model="current_product.title">
                             </textarea>
                         </div>
                     </div>
             ...
             <div class="d-flex flex-column gap-10">
                 <div class="add-product-container">
                     ...
                     <div class="row my-5">
                         <div class="col-12">
                             <label>Price ($)</label>
                             <input class="form-control" type="text" wire:model="outgoing_product.price">
                         </div>
                     </div>
                     ...
                     <div class="row mb-3">
                         <div class="col-4">
                             <label>Length</label>
                             <input class="form-control" type="text" wire:model="outgoing_product.length">
                         </div>
                         <div class="col-4">
                             <label>Width.</label>
                             <input class="form-control" type="text" wire:model="outgoing_product.width">
                         </div>
                         <div class="col-4">
                             <label>Height</label>
                             <input class="form-control" type="text" wire:model="outgoing_product.height">
                         </div>
                     </div>
                     ...
                     <div class="row mb-3">
                         <div class="col-6">
                             <label>Actual Wt.</label>
                             <input class="form-control" type="text" wire:model="outgoing_product.a_weight">
                         </div>
                         <div class="col-6">
                             <label>Deci Wt.</label>
                             <input class="form-control" type="text" wire:model="outgoing_product.d_weight">
                         </div>
                     </div>
                     ...
                     <div class="row mb-3">
                         <div class="col-12">
                             <label>Description</label>
                             <textarea class="form-control" rows="3" wire:model="outgoing_product.title">
                             </textarea>
                         </div>
                     </div>
