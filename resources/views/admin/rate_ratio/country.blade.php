                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <!--end::Svg Icon-->
                            <input type="text" data-kt-rate_ratio-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Rate ratios" />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
                    ...
                    <div class="card-toolbar">
                        <!--begin::Group actions-->
                        <div class="d-flex justify-content-end align-items-center d-none" data-kt-rate_ratio-table-toolbar="selected">
                            <div class="fw-bold me-5">
                                <span class="me-2" data-kt-rate_ratio-table-select="selected_count"></span>Selected
                            </div>
                            <button type="button" class="btn btn-danger" data-kt-rate_ratio-table-select="delete_selected">Delete Selected</button>
                        </div>
                        <!--end::Group actions-->
                    </div>
                    <!--end::Card toolbar-->
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            ...
                            <tr id="datatable-row-{{$country->id}}">
                                ...
                                <td class="datatable-td-carrier" data-id="{{$country->name}}">
                                    <a href="{{route('admin.rate_ratio.view', ['carrier_id' => $carrier_id, 'country_id' => $country->id])}}">
                                        {{$country->name}}
                                    </a>
                                </td>
                            </tr>
