    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="#" class="btn btn-sm fw-bold btn-danger">Delete</a>
                ...
                <div class="flex-xxl-row-fluid mb-10 mb-xxl-0 me-xxl-7 me-xxxl-10">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-12">
                            <!--begin::Form-->
                            <form class="form" action="{{isset($invoice) ? route('admin.invoice.update', $invoice->id) : route('admin.invoice.store')}}" id="kt_create_form" method="{{isset($invoice) ? 'PUT' : 'POST'}}" enctype="multipart/form-data">
                                @csrf
                                <!--begin::Wrapper-->
                                        ...
                                        <table class="table g-5 gs-0 mb-0 fw-bold text-gray-700" data-kt-element="items" id="product_table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="border-bottom border-bottom-dashed" data-kt-element="item">
                                                    ...
                                                    <td class="ps-0">
                                                        <div class="mb-5 fv-row">
                                                            <input class="form-control form-control-solid" type="number" min="1" name="quantity[]" placeholder="1" value="{{$invoice_product->quantity}}" data-kt-element="quantity" />
                                                            <div class="fv-plugins-message-container invalid-feedback">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="mb-5 fv-row">
                                                            <input type="text" class="form-control form-control-solid text-end" name="cost[]" placeholder="0.00" value="{{$invoice_product->cost}}" data-kt-element="cost" />
                                                            <div class="fv-plugins-message-container invalid-feedback">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="mb-5 fv-row">
                                                            <input type="text" class="form-control form-control-solid text-end" name="price[]" placeholder="0.00" value="{{$invoice_product->price}}" data-kt-element="price" />
                                                            <div class="fv-plugins-message-container invalid-feedback">
                                                            </div>
                                                        </div>
                                                    </td>
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="border-bottom border-bottom-dashed" data-kt-element="payment">
                                                    <td class="pe-7">
                                                        <!--begin::Input group-->
                                                        <div class="mb-5 fv-row">
                                                            <select name="payment_mode[]" class="form-select form-select-lg form-select-solid" data-control="select2" data-placeholder="Select a payment mode">
                                                                <option value="">Select a payment mode</option>
                                                                <option value="bank" {{$invoice_payment->mode == 'bank' ? 'selected' : ''}}>
                                                                    Bank Payment</option>
                                                                <option value="cash" {{$invoice_payment->mode == 'cash' ? 'selected' : ''}}>
                                                                    Cash Payment</option>
                                                                <option value="others" {{$invoice_payment->mode == 'others' ? 'selected' : ''}}>
                                                                    Others</option>
                                                            </select>
                                                            <div class="fv-plugins-message-container invalid-feedback">
                                                            </div>
                                                    ...
                                                    <td class="ps-0">
                                                        <div class="mb-5 fv-row">
                                                            <input class="form-control form-control-solid" placeholder="Select payment date" name="payment_date[]" value="{{(new DateTime($invoice_payment->date))->format('d-M-Y')}}" data-kt-element="payment_date" />
                                                            <div class="fv-plugins-message-container invalid-feedback">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="mb-5 fv-row">
                                                            <input type="text" class="form-control form-control-solid text-end" name="payment_amount[]" placeholder="0.00" value="{{$invoice_payment->amount}}" data-kt-element="payment_amount" />
                                                            <div class="fv-plugins-message-container invalid-feedback">
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr class="border-bottom border-bottom-dashed" data-kt-element="payment">
                                                    <td class="pe-7">
                                                        <!--begin::Input group-->
                                                        <div class="mb-5 fv-row">
                                                            <select name="payment_mode[]" class="form-select form-select-lg form-select-solid" data-control="select2" data-placeholder="Select a payment mode" data-kt-element="payment_mode">
                                                                <option value="">Select a payment mode</option>
                        ...
                        <div class="card-body p-10">
                            ...
                            <div class="mb-8">
                                ...
                                <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack mb-5">
                                    <span class="form-check-label ms-0 fw-bold fs-6 text-gray-700">Email invoice to
                                        customer</span>
