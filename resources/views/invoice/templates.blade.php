      ...
      <tr class="border-bottom border-bottom-dashed" data-kt-element="item">
          <td class="pe-7">
              ...
              <div class="mb-5 fv-row">
                  <select name="product[]" class="form-select form-select-lg form-select-solid product_select"
              ...
              <!--end::Input group-->
              <input type="text" class="form-control form-control-solid product_description"
  ...
  <table class="table d-none" data-kt-element="payment-template">
      <tr class="border-bottom border-bottom-dashed" data-kt-element="payment">
          <td class="pe-7">
              <!--begin::Input group-->
              <div class="mb-5 fv-row">
                  <select name="payment_mode[]" class="form-select form-select-lg form-select-solid"
          ...
          <td class="ps-0">
              <div class="mb-5 fv-row">
                  <input class="form-control form-control-solid" placeholder="Select payment date" name="payment_date[]"
