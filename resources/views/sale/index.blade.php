            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="d-flex flex-stack mb-5 table-toolbar">
                        ...
                        <div class="table-search d-flex align-items-center position-relative my-1">
                            ...
                            <span class="svg-icon svg-icon-1 position-absolute ms-6">
                                <svg width="24" height="24" viewSale="0 0 24 24" fill="none"
                        ...
                        <div class="d-flex justify-content-end gap-2" data-kt-docs-table-toolbar="base">
                            ...
                            <div>
                                <input class="form-control form-control-solid datetimepicker-input"
                                    placeholder="Pick date range" name="sales_range" data-filter-target="sales_range" />
                            </div>
                            <!--end::Input-->
                            <!--begin::Filter menu-->
                            <div class="m-0">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
                                    ...
                                    <div class="px-7 py-5">
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <div>
                                                <select
                                                    class="form-select form-select-solid filter-option sale_calculation"
                                                    data-kt-select2="true" data-placeholder="Select option"
                                                    data-filter-target="sale_calculation" data-filter-type="date"
                            ...
                            <div id="kt_datatable_export_menu"
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{route(Auth::user()->role . '.sale.export', 'excel')}}"
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{route(Auth::user()->role . '.sale.export', 'csv')}}"
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{route(Auth::user()->role . '.sale.export', 'pdf')}}"
                    ...
                    <form id="view_form" method="POST">
                        @csrf
                        @method('POST')
                        <input type="hidden" name="sale_calculation" id="sale_calculation_field">
