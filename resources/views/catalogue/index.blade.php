                    ...
                    <div class="d-flex flex-stack mb-5 table-toolbar">
                        ...
                        <div class="table-search d-flex align-items-center position-relative my-1">
                            ...
                            <span class="svg-icon svg-icon-1 position-absolute ms-6">
                                <svg width="24" height="24" viewCatalogue="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect opacity="0.5" x="17.0365" y="15.1223" width="8.15546" height="2" rx="1" transform="rotate(45 17.0365 15.1223)" fill="currentColor" />
                                    <path d="M11 19C6.55556 19 3 15.4444 3 11C3 6.55556 6.55556 3 11 3C15.4444 3 19 6.55556 19 11C19 15.4444 15.4444 19 11 19ZM11 5C7.53333 5 5 7.53333 5 11C5 14.4667 7.53333 17 11 17C14.4667 17 17 14.4667 17 11C17 7.53333 14.4667 5 11 5Z" fill="currentColor" />
                                </svg>
                            </span>
                            <!--end::Svg Icon-->
                            <input type="text" data-kt-docs-table-filter="search" class="table-search-input form-control form-control-solid w-250px ps-15" placeholder="Search Catalogues" />
                        </div>
                        <!--end::Search-->
                        ...
                        <div class="d-flex justify-content-end gap-2" data-kt-docs-table-toolbar="base">
                            ...
                            <div id="kt_datatable_export_menu" class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{route('admin.catalogue.export', 'excel')}}" class="menu-link px-3" data-kt-export="excel">
                                        Export as Excel
                                    </a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{route('admin.catalogue.export', 'csv')}}" class="menu-link px-3" data-kt-export="csv">
                                        Export as CSV
                                    </a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{route('admin.catalogue.export', 'pdf')}}" class="menu-link px-3" data-kt-export="pdf">
                                        Export as PDF
                                    </a>
                                </div>
                                <!--end::Menu item-->
                            ...
                            <a href="{{route('admin.catalogue.create')}}">
                                <button type="button" class="btn btn-primary">Add Catalogue</button>
                            </a>
                            <!--end::Add Record -->
                        </div>
                        <!--end::Toolbar-->
...
<script src="{{asset('js/catalogue/index.js')}}"></script>
