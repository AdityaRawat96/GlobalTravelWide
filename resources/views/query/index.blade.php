                    ...
                    <div class="d-flex flex-stack mb-5 table-toolbar">
                        ...
                        <div class="table-search d-flex align-items-center position-relative my-1">
                            ...
                            <span class="svg-icon svg-icon-1 position-absolute ms-6">
                                <svg width="24" height="24" viewQuery="0 0 24 24" fill="none"
                        ...
                        <div class="d-flex justify-content-end gap-2" data-kt-docs-table-toolbar="base">
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <label
                                                ...
                                                <input class="form-check-input filter-option" type="checkbox"
                                                    data-filter-target="user_id" data-filter-type="text"
                                                    value="=,{{Auth::user()->id}}">
                            ...
                            <div id="kt_datatable_export_menu"
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{route(Auth::user()->role . '.query.export', 'excel')}}"
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{route(Auth::user()->role . '.query.export', 'csv')}}"
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{route(Auth::user()->role . '.query.export', 'pdf')}}"
                            ...
                            <!--end::Export dropdown-->
                            <!--begin::Add Record -->
                            <a href="{{route(Auth::user()->role . '.query.create')}}">
...
<script src="{{asset('js/query/index.js')}}"></script>
