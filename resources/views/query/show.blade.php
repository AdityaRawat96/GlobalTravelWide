        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <h1 class="page-heading d-flex fw-bold fs-3 flex-column justify-content-center my-0">
                    {{ str_pad($query->id, 5, '0', STR_PAD_LEFT) }}
                </h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                ...
                <div class="content">
                    ...
                    <form class="form" action="{{isset($query) ? route(Auth::user()->role . '.query.update', $query->id) : route(Auth::user()->role . '.query.store')}}" id="kt_create_form" method="{{isset($query) ? 'PUT' : 'POST'}}">
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="mb-5 fv-row">
                                        <input id="customer_name" type="text" class="form-control form-control-solid" value="{{isset($query) ? $query->customer->name : null}}" placeholder="Customer Name" disabled />
                                    </div>
                                    <!--end::Input group-->
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="date" id="query_date" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Pick date & time" value="{{isset($query->date) ? $query->date : null}}" disabled />
                            ...
                            <div class="row mb-6">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="status" id="status" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Pick date & time" value="{{isset($query->status) ? ucfirst($query->status) : null}}" disabled />
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                                <!--end::Col-->
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <textarea name="notes" class="form-control form-control-lg form-control-solid" rows="3" placeholder="Description" disabled>{{isset($query->notes) ? $query->notes : null}}</textarea>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                        ...
                        <div class="card-footer d-flex justify-content-end py-6 px-9">
                            ...
                            <a href="{{route(Auth::user()->role . '.query.edit', $query->id)}}" class="btn btn-primary">Edit</a>
                        </div>
                        <!--end::Actions-->
                    </form>
                    <!--end::Form-->
...
<script src="{{asset('js/query/show.js')}}"></script>
