        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <h1 class="page-heading d-flex fw-bold fs-3 flex-column justify-content-center my-0">
                    {{isset($affiliate) ? "Update" : "Add" }} Affiliate
                </h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div class="content">
                    <!--begin::Form-->
                    <form class="form"
                        action="{{isset($affiliate) ? route(Auth::user()->role . '.affiliate.update', $affiliate->id) : route(Auth::user()->role . '.affiliate.store')}}"
                        id="kt_create_form" method="{{isset($affiliate) ? 'PUT' : 'POST'}}">
                        @csrf
                        <!--begin::Card body-->
                        ...
                        <div class="card-footer d-flex justify-content-end py-6 px-9">
                            ...
                            <button type="button" id="kt_form_submit" class="btn btn-primary">
                                <span class="indicator-label">
                                    {{isset($affiliate) ? 'Update' : 'Save'}}</span>
                                </span>
...
<script src="{{asset('js/affiliate/create.js')}}"></script>
