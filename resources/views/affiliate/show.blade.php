        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <h1 class="page-heading d-flex fw-bold fs-3 flex-column justify-content-center my-0">
                    {{ "C" . str_pad($affiliate->id, 5, '0', STR_PAD_LEFT) }}
                </h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div class="content">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="name"
                                    ...
                                    value="{{isset($affiliate->name) ? $affiliate->name : null}}" disabled />
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="tel" name="phone" class="form-control form-control-lg form-control-solid"
                                    ...
                                    value="{{isset($affiliate->phone) ? $affiliate->phone : null}}" disabled />
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="email" name="email" class="form-control form-control-lg form-control-solid"
                                    ...
                                    value="{{isset($affiliate->email) ? $affiliate->email : null}}" disabled />
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                    ...
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        ...
                        <a href="{{route(Auth::user()->role . '.affiliate.edit', $affiliate->id)}}"
...
<script src="{{asset('js/affiliate/show.js')}}"></script>
