    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form class="form" action="{{route('user.profile.updateCard')}}" id="kt_modal_update_card_form"
                    method="POST">
                    @csrf
                    <input id="card_id" type="text" name="id" hidden />
                    <!--begin::Input group-->
                    ...
                    <div class="d-flex flex-column mb-7 fv-row">
                        ...
                        <div class="position-relative">
                            ...
                            <input id="card_type" type="text" name="card_type" hidden />
                            <!--end::Input-->
                            <!--begin::Card logos-->
                            <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                ...
                                <img class="card-logo-input card-logo-american-express h-25px d-none"
                                    src="{{asset('media/svg/card-logos/american-express.svg')}}" alt="" />
                            </div>
                            <!--end::Card logos-->
                        </div>
                        <!--end::Input wrapper-->
                    ...
                    <div class="d-flex flex-stack">
                        ...
                        <div class="me-5">
                            ...
                            <div class="fs-7 fw-semibold text-muted">This card would be auto selected for future
                                transactions if set default.</div>
                        </div>
                        <!--end::Label-->
                        <!--begin::Switch-->
                        <label class="form-check form-switch form-check-custom form-check-solid">
                            <input name="default" class="form-check-input" type="checkbox" />
                        </label>
                        <!--end::Switch-->
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="text-center pt-15">
                        <button type="reset" id="kt_modal_update_card_cancel"
                            class="btn btn-light me-3">Discard</button>
                        <button type="button" id="kt_modal_update_card_submit" class="btn btn-primary">
