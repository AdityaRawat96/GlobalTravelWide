    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form class="form" action="{{route('user.profile.addCard')}}" id="kt_modal_new_card_form" method="POST">
                    @csrf
                    <!--begin::Input group-->
                    ...
                    <div class="text-center pt-15">
                        ...
                        <button type="button" id="kt_modal_new_card_submit" class="btn btn-primary">
