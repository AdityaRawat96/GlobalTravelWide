...
<div class="modal fade" id="kt_modal_update_address" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            <!--begin::Form-->
            <form class="form" action="{{route('user.profile.updateAddress')}}" id="kt_modal_update_address_form"
                method="POST">
                @csrf
                <input id="address_id" type="text" name="id" hidden />
                <!--begin::Modal header-->
                ...
                <div class="modal-body py-10 px-lg-17">
                    <!--begin::Scroll-->
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_update_address_scroll" data-kt-scroll="true"
                        ...
                        <div class="d-flex flex-column mb-5 fv-row">
                            ...
                            <select name="country" data-control="select2"
                                data-dropdown-parent="#kt_modal_update_address" data-placeholder="Select a Country..."
                ...
                <div class="modal-footer flex-center">
                    ...
                    <!--end::Button-->
                    <!--begin::Button-->
                    <button type="button" id="kt_modal_update_address_submit" class="btn btn-primary">
