                ...
                <div class="card-body pt-9 pb-0">
                    ...
                    <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                        ...
                        <div class="me-7 mb-4">
                            <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                <img src="{{isset($data['user']->avatar) ? asset('storage/'.$data['user']->avatar) : asset('media/svg/avatars/blank.svg')}}" alt="image" />
                            </div>
                        </div>
                        <!--end::Pic-->
                        <!--begin::Info-->
                            ...
                            <div class="d-flex justify-content-between align-items-start flex-wrap mb-2 mt-5">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{{$data["user"]->first_name}}
                    ...
                    <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                        ...
                        <li class="nav-item mt-2">
                            <a class="nav-link nav-link-profile-tab text-active-primary ms-0 me-10 py-5 active" href="" data-target="#profile-tab-overview">Overview</a>
                        </li>
                        <!--end::Nav item-->
                        <!--begin::Nav item-->
                        <li class="nav-item mt-2">
                            <a class="nav-link nav-link-profile-tab text-active-primary ms-0 me-10 py-5" href="" data-target="#profile-tab-settings">Settings</a>
                        </li>
                    </ul>
                    <!--begin::Navs-->
                </div>
...
<script src="{{asset('js/custom/apps/profile/main.js')}}"></script>
