    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div class="content">
                    <!--begin::Form-->
                    <form class="form" action="{{isset($expense) ? route(Auth::user()->role . '.expense.update', $expense->id) : route(Auth::user()->role . '.expense.store')}}" id="kt_create_form" method="{{isset($expense) ? 'PUT' : 'POST'}}">
                        @csrf
                        <!--begin::Card body-->
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="date" id="expense_date" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Pick date & time" value="{{isset($expense->date) ? $expense->date : null}}" disabled />
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-6">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="amount" id="amount" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Expense amount" value="{{isset($expense->amount) ? $expense->amount : null}}" disabled />
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-6">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <textarea name="description" class="form-control form-control-lg form-control-solid" rows="3" placeholder="Description" disabled>{{isset($expense->description) ? $expense->description : null}}</textarea>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-6 fv-row">
                                    ...
                                    <!--end::Dropzone-->
                                    @if(count($expense_attachments) == 0)
                                    <!--begin::Hint-->
                        ...
                        <div class="card-footer d-flex justify-content-end py-6 px-9">
                            ...
                            <a href="{{route(Auth::user()->role . '.expense.edit', $expense->id)}}" class="btn btn-primary">Edit</a>
                        </div>
                        <!--end::Actions-->
                    </form>
                    <!--end::Form-->
...
<script src="{{asset('js/expense/show.js')}}"></script>
