                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end align-items-center d-none"
                            ...
                            <button type="button" class="btn btn-danger"
                                data-kt-transaction-table-select="delete_selected">Delete Selected</button>
                        </div>
                        <!--end::Group actions-->
                    </div>
                    <!--end::Card toolbar-->
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_transactions_table">
                        ...
                        <tbody class="fs-6 fw-semibold text-gray-600">
                            ...
                            <tr>
                                ...
                                <!--end::order=-->
                                <td>#SL{{ str_pad($transaction->user_id, 5, "0", STR_PAD_LEFT) }}</td>
                                <!--begin::Status=-->
                                <td>
                                ...
                                <td style="text-transform: capitalize;">
                                    {{$transaction->type == 'manual' ? $transaction->notes : $transaction->type}}</td>
                                <td>
                                ...
                                <td class="text-end">
                                    <div class="d-flex justify-content-end flex-shrink-0">
                                        <a data-bs-toggle="modal" data-bs-target="#kt_modal_view_transaction"
                                            onclick="viewTableRow('{{$transaction->id}}', '{{$transaction}}')"
                                        ...
                                        <a data-bs-toggle="modal" data-bs-target="#kt_modal_update_transaction"
                                            onclick="editTableRow('{{$transaction->id}}', '{{$transaction}}')"
                                            class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                        ...
                                        <a onclick="deleteTableRow(`{{route('admin.transaction.delete',$transaction->id)}}`, `{{$transaction->id}}`)"
                                            data-kt-transaction-table-filter="delete_row"
...
@include('admin.transactions.modals')
@stop
...
<script src="{{asset('js/custom/apps/transactions/index.js')}}"></script>
<script src="{{asset('js/custom/apps/transactions/update.js')}}"></script>
