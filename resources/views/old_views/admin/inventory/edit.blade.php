...
<div class="d-flex flex-column flex-column-fluid">
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <!--begin::Form-->
            <form class="form d-flex flex-column flex-lg-row" action="{{route('admin.inventory.update', $product->id)}}"
                id="kt_ecommerce_edit_product_form" method="POST" enctype="multipart/form-data"
                data-kt-redirect="{{route('admin.inventory.view', $product->user_id)}}">
                @method('PUT')
                @csrf
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                ...
                                name="status" data-value="{{$product->status}}">
                                <option></option>
                            ...
                            <div class="{{$product->scheduled ? '' : 'd-none'}} mt-10">
                                ...
                                <input class="form-control" id="kt_ecommerce_add_product_status_datepicker"
                                    placeholder="Pick date & time" name="scheduled" value="{{$product->scheduled}}" />
                            </div>
                            <!--end::Datepicker-->
                        </div>
                        <!--end::Card body-->
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="asin" id="asin" class="form-control mb-2"
                                                placeholder="ASIN Number" value="{{$product->asin}}" />
                                            <!--end::Input-->
                                            <!--begin::Description-->
                                        ...
                                        <div class="text-end mb-3">
                                            <button class="btn btn-primary"
                                                onclick="searchProduct(`{{route('admin.inventory.searchProduct')}}`)"
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="product_title" class="form-control mb-2"
                                        ...
                                        <div>
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Editor-->
                                            <textarea name="product_description" class="form-control min-h-200px mb-2"
                                                ...
                                                <div class="form-group">
                                                    <div data-repeater-list="kt_ecommerce_add_product_options"
                                                        ...
                                                        <div data-repeater-item=""
                                                            class="form-group d-flex flex-wrap align-items-center gap-5 product_variations">
                                                            <!--begin::Select2-->
                                                            <div class="w-100 w-md-200px">
                                                                <select class="form-select selected-variation"
                                                                    name="product_option"
                                                                    data-placeholder="Select a variation"
                                                                    data-kt-ecommerce-catalog-add-product="product_option"
                                                                    data-value="{{$variation->product_option}}">
                                                                    <option></option>
                                                            ...
                                                            <input type="text" class="form-control mw-100 w-200px"
                                                                ...
                                                                value="{{$variation->product_option_value}}" />
                                                            <!--end::Input-->
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    ...
                                                    <div class="mb-10 fv-row">
                                                        ...
                                                        <input type="text" name="items" class="form-control mb-2"
                                                            placeholder="Number of items" value="{{$product->items}}" />
                                                        <!--end::Editor-->
                                                        <!--begin::Description-->
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <input type="text" class="form-control mb-2" name="meta_title"
                                                placeholder="Meta tag name" value="{{$product->meta_title}}" />
                                            <!--end::Input-->
                                            <!--begin::Description-->
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Editor-->
                                            <textarea name="kt_ecommerce_add_product_meta_description"
                                                class="form-control min-h-100px mb-2">{{$product->meta_description}}</textarea>
                                            <!--end::Editor-->
                                            <!--begin::Description-->
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="fv-row mb-2">
                                            <input type="file" class="form-control form-control-solid"
                                                id="product_media" placeholder="" name="product_media[]" multiple />
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <input type="text" name="price" class="form-control mb-2"
                                                placeholder="Product price" value="{{$product->base_price}}" />
                                            <!--end::Input-->
                                            <!--begin::Description-->
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <div class="row row-cols-1 row-cols-md-3 row-cols-lg-1 row-cols-xl-3 g-9"
                                                ...
                                                <div class="col">
                                                    <!--begin::Option-->
                                                    <label
                                                        class="btn btn-outline btn-outline-dashed btn-active-light-primary d-flex text-start p-6 {{$product->discount_type === 'none' ? 'active' : ''}}"
                                                        data-kt-button="true">
                                                        <!--begin::Radio-->
                                                        <span
                                                            class="form-check form-check-custom form-check-solid form-check-sm align-items-start mt-1">
                                                            <input class="form-check-input" type="radio"
                                                                name="discount_option" value="none"
                                                                {{$product->discount_type === 'none' ? 'checked' : ''}} />
                                                        </span>
                                                        <!--end::Radio-->
                                                        <!--begin::Info-->
                                                        <span class="ms-5">
                                                ...
                                                <div class="col">
                                                    <!--begin::Option-->
                                                    <label
                                                        class="btn btn-outline btn-outline-dashed btn-active-light-primary d-flex text-start p-6 {{$product->discount_type === 'variable' ? 'active' : ''}}"
                                                        data-kt-button="true">
                                                        <!--begin::Radio-->
                                                        <span
                                                            class="form-check form-check-custom form-check-solid form-check-sm align-items-start mt-1">
                                                            <input class="form-check-input" type="radio"
                                                                name="discount_option" value="variable"
                                                                {{$product->discount_type === 'variable' ? 'checked' : ''}} />
                                                        </span>
                                                        <!--end::Radio-->
                                                        <!--begin::Info-->
                                                        <span class="ms-5">
                                                ...
                                                <div class="col">
                                                    <!--begin::Option-->
                                                    <label
                                                        class="btn btn-outline btn-outline-dashed btn-active-light-primary d-flex text-start p-6 {{$product->discount_type === 'fixed' ? 'active' : ''}}"
                                                        data-kt-button="true">
                                                        <!--begin::Radio-->
                                                        <span
                                                            class="form-check form-check-custom form-check-solid form-check-sm align-items-start mt-1">
                                                            <input class="form-check-input" type="radio"
                                                                name="discount_option" value="fixed"
                                                                {{$product->discount_type === 'fixed' ? 'checked' : ''}} />
                                                        </span>
                                                        <!--end::Radio-->
                                                        <!--begin::Info-->
                                                        <span class="ms-5">
                                        ...
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="mb-10 fv-row {{$product->discount_type === 'variable' ? '' : 'd-none'}}"
                                            ...
                                            <div class="d-flex flex-column text-center mb-5">
                                                <div class="d-flex align-items-start justify-content-center mb-7">
                                                    <span class="fw-bold fs-3x"
                                                        id="kt_ecommerce_add_product_discount_label">{{(($product->base_price - $product->price) / $product->price) * 100}}</span>
                                                    <span class="fw-bold fs-4 mt-1 ms-2">%</span>
                                                </div>
                                                <div id="kt_ecommerce_add_product_discount_slider" class="noUi-sm">
                                                </div>
                                                <input type="text" name="dicsounted_price_percentage"
                                                    class="form-control mb-2" placeholder="Discounted price"
                                                    value="{{(($product->base_price - $product->price) / $product->price) * 100}}" />
                                            </div>
                                            <!--end::Slider-->
                                            <!--begin::Description-->
                                        ...
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="mb-10 fv-row {{$product->discount_type === 'fixed' ? '' : 'd-none'}}"
                                        ...
                                        <div class="d-flex flex-wrap gap-5">
                                            ...
                                            <div class="fv-row w-100 flex-md-root">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" class="form-control mb-2" value="{{$product->vat}}"
                                                    name="vat" />
                                                <!--end::Input-->
                                                <!--begin::Description-->
                    ...
                    <div class="d-flex justify-content-end">
                        <!--begin::Button-->
                        <a href="{{route('admin.inventory.index', $product->user_id)}}"
