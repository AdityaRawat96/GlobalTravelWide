    ...
    <div class="stepper stepper-links d-flex flex-column " id="kt_create_account_stepper"
        ...
        <div class="form d-flex flex-column flex-lg-row" id="order-form-container">
            <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                @include('admin.order.wizard-step.aside')
            </div>
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                <div>
                    @include('admin.order.wizard-step.step0')
                    @include('admin.order.wizard-step.step1')
                    @include('admin.order.wizard-step.step2')
                    @include('admin.order.wizard-step.step3')
                    @include('admin.order.wizard-step.step4')
                    @include('admin.order.wizard-step.step5')
                    @include('admin.order.wizard-step.step6')
                    @include('admin.order.wizard-step.step7')
                </div>
