        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="d-flex flex-column gap-7 gap-lg-10">
                ...
                <div class="d-flex flex-wrap flex-stack gap-5 gap-lg-10">
                    <!--begin::Button-->
                    <a href="{{route('admin.order.index')}}" class="btn btn-icon btn-primary btn-sm ">
                    ...
                    <div>
                        <!--begin::Button-->
                        <a href="{{route('admin.order.edit', $data['order']->order_id)}}"
                        ...
                        <button type="button" class="btn btn-primary btn-sm mx-1" data-bs-toggle="modal"
                            data-bs-target="#kt_modal_update_shipping">Update Shipping</button>
                        <!--end::Button-->
                        <!--begin::Button-->
                        <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                            data-bs-target="#kt_modal_update_status">Update Status</button>
                        <!--end::Button-->
                    </div>
                </div>
                        ...
                        <div class="aside-column">
                                    ...
                                    <div class="d-flex flex-column gap-10">
                                        ...
                                        <div class="fv-row">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <!--end::Input-->
                                                <span class="badge badge-light-warning mt-3"
                                                    style="margin-left: auto">{{$data['order']->status}}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card card-flush py-4 mb-5">
                                ...
                                <div class="card-body pt-0">
                                    <div class="d-flex flex-column gap-10">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-end pe-5">
                                                            <span
                                                                class="fw-bold text-warning ms-3">{{$product['qty']}}</span>
                                                        </td>
                                                        <!--end::Qty=-->
                                                    </tr>
                                                    <?php $total_products += $product['qty']; ?>
                                                    @endforeach
                                                    <tr>
                                                        <td class="text-end">
                                                        ...
                                                        <td class="text-end pe-5">
                                                            <span
                                                                class="fw-bold text-warning ms-3">{{$total_products}}</span>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <!--begin::Button-->
                                        <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#kt_modal_update_products">View Products</button>
                                        <!--end::Button-->
                                    </div>
                                </div>
                                <!--end::Card header-->
                                ...
                                <div class="card-body pt-0">
                                    <div class="d-flex flex-column gap-10">
                                        <div class="carrier-list">
                                            <div
                                                class="align-items-center border border-dashed rounded p-3 bg-body mb-5">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <!--begin:Option-->
                                                        <label class="d-flex flex-stack mb-5 cursor-pointer">
                                                            ...
                                                            <span class="d-flex align-items-center me-2">
                                                                ...
                                                                <div class="symbol symbol-45px me-4">
                                                                    ...
                                                                    <img src="{{Storage::disk('s3')->url($data['carrier']['logo'])}}"
                                                                        alt="carrier logo" class="img-fluid">
                                                                    @else
                                                                    <span class="symbol-label bg-primary">
                                                                        <i
                                                                            class="text-inverse-primary fs-1 lh-0 fonticon-delivery"></i>
                                                                    </span>
                                                                    @endif
                                                                </div>
                                                                <!--end:Icon-->
                            ...
                            <div class="card card-flush py-4 mb-5">
                                ...
                                <div class="card-body pt-0">
                                    <div class="d-flex flex-column gap-10">
                                        ...
                                        <!--begin::Button-->
                                        <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#kt_modal_view_labels">View Labels</button>
                                        <!--end::Button-->
                                    </div>
                                </div>
                                <!--end::Card header-->
                            ...
                            <div class="card card-flush py-4 mb-5">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    @else
                                    <div
                                        class="notice d-flex bg-light-warning rounded border-warning border border-dashed my-5 p-6">
                                        <!--begin::Icon-->
                                        ...
                                        <span class="svg-icon svg-icon-2tx svg-icon-warning me-4"><svg width="24"
                                    ...
                                    <div class="d-flex flex-column gap-10">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 col-sm-12">
                                                <div class="w-100">
                                                    <span class="badge py-4 px-4 fs-7 badge-light-primary">{{$key + 1}}.
                                                        {{$bin['name']}}</span>
                                                    <button type="button" class="btn btn-primary btn-sm"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#kt_modal_view_bin_products"
                                                        onclick="setBinProducts({{$key}})">
                                            ...
                                            <div class="col-md-4 col-sm-12">
                                                <div class="w-100 d-flex"
                                                    ...
                                                    <h5 class="mt-2">Cost Breakdown</h5>
                                                    <button type="button" class="btn btn-primary btn-sm"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#kt_modal_update_package_cost" onclick="updateModalCost(
                                                            {{$bin['import_fee']}}, 
                                                            {{$bin['shipping_fee']}}, 
                                                            {{$key}}
                                                            )">
                                                ...
                                                <table class="table table-row-dashed">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="table-summary-label">Total:</td>
                                                            <td class="table-summary-data">$
                                                                {{$bin['insurance_selected'] ? number_format($bin['insurance_price'] + $bin['import_fee'] + $bin['shipping_fee'], 2) : number_format($bin['import_fee'] + $bin['shipping_fee'], 2)}}
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                ...
                                                <div class="d-flex w-100">
                                                    <div class="symbol symbol-45px me-4">
                                                        <img src="{{Storage::disk('s3')->url($data['shipping'][$key]['carrier_logo'])}}"
                                                            alt="carrier logo" class="img-fluid">
                                                    </div>
                                                    <div>
                                                        <b>Tracking ID:</b><br />
                                    ...
                                    <div class="d-flex flex-column gap-10">
                                        ...
                                        <div class="flex justify-end mt-2 text-end">
                                            ...
                                            <small class="fs-6">
                                                Cost per product:
                                                <b
                                                    class="cost_per_product">${{number_format($data['order']->total / $data['order']->product_count, 2)}}</b>
                                            </small>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end pe-5">
                                                    <textarea class="form-control" rows="3"
                                                        readonly>{{$product['notes']}}</textarea>
                                                </td>
                                                <!--end::Qty=-->
                                            </tr>
                                            @endif
...
@include('admin.order.modals.update_status_modal')
@include('admin.order.modals.update_shipping_modal')
@include('admin.order.modals.update_products_modal')
@include('admin.order.modals.view_labels_modal')
@include('admin.order.modals.update_package_cost_modal')
@include('admin.order.modals.view_bin_products_modal')
...
<script src="{{asset('js/custom/apps/orders/update_status.js')}}"></script>
<script src="{{asset('js/custom/apps/orders/update_shipping.js')}}"></script>
<script src="{{asset('js/custom/apps/orders/update_cost.js')}}"></script>
