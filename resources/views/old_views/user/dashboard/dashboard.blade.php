                    ...
                    <div class="row">
                        <div class="col-xxl-12 col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-5">
                            ...
                            <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end mb-5 mb-xl-10"
                                style="background-color: #F1416C;background-image:url({{asset('media/patterns/vector-1.png')}}); height: 100% !important;">
                                <!--begin::Header-->
                                <div class="card-header pt-5">
                                    ...
                                    <div class="card-title d-flex flex-column">
                                        <!--begin::Amount-->
                                        <span
                                            class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2">{{$data['active_shipments']}}</span>
                                        <!--end::Amount-->
                                        <!--begin::Subtitle-->
                                    ...
                                    <div class="d-flex align-items-center flex-column mt-3 w-100">
                                        ...
                                        <div class="h-8px mx-3 w-100 bg-white bg-opacity-50 rounded">
                                            <div class="bg-white rounded h-8px" role="progressbar"
                                                style="width: <?= $data['active_shipments'] ? (($data['processing_shipments'] / $data['active_shipments']) * 100) : 0 ?>%;"
                                ...
                                <div class="card-header pt-5">
                                    ...
                                    <div class="card-title d-flex flex-column">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--begin::Amount-->
                                            <span
                                                class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2">{{number_format($data['wallet_balance'], 2, '.', ',')}}</span>
                                            <!--end::Amount-->
                                        </div>
                                        <!--end::Info-->
                                        <!--begin::Subtitle-->
                                ...
                                <table class="table table-row-dashed align-middle gs-0 gy-3 my-0" id="kt-orders-table">
                                    ...
                                    <tbody class="fw-semibold text-gray-600">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="badge badge-light status-badge-{{strtolower($order->status)}} fw-bold px-4 py-3">{{$order->status}}</span>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{route('user.order.view', $order->order_id)}}"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="#" class="menu-link px-3"
                                                            onclick="deleteTableRow(`{{route('user.order.delete', $order->order_id)}}`, `{{$index}}`)"
