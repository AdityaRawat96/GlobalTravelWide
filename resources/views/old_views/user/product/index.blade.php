...
<div id="ship_from_address_container" class="d-none">
    <div class="text-start">
        <br /><br />
        Please ship your order to this address:
        <br />
        <div class="d-flex flex-row">
            <p class="mt-3 fs-5 flex-1" id="ship_from_address">
                <span>{{ Auth::user()->first_name . " " . Auth::user()->last_name . " " . " #SL" . str_pad(Auth::user()->id, 5, "0", STR_PAD_LEFT) }}</span><br><br>
                <span>{{ $warehouse_address['street'] }}</span><br>
                <span>{{$warehouse_address['name']. " #SL" . str_pad(Auth::user()->id, 5, "0", STR_PAD_LEFT)}}</span><br>
                <span>{{ $warehouse_address['city'] }}</span><br>
                <span>{{ $warehouse_address['state'] }}</span>
                <span>{{ $warehouse_address['zip'] }}</span><br>
            </p>
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar" style="flex: 1;">
                        ...
                        <div class="d-flex justify-content-start align-items-center d-none"
                            data-kt-product-table-toolbar="selected" id="action_container" style="margin-right: auto;">
                            <a href="#" class="btn btn-sm btn-light btn-active-light-primary py-4 mx-3"
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                ...
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-bs-toggle="modal"
                                        data-bs-target="#kt_modal_create_order"
                                        data-kt-product-table-select="create_order">Create Order</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-bs-toggle="modal"
                                        data-bs-target="#kt_modal_create_shipment"
                                        data-kt-product-table-select="create_shipment">Send to warehouse</a>
                                </div>
                                <!--end::Menu item-->
                            </div>
                            <!--end::Menu-->
                            <div class="fw-bold me-5 text-primary">
                        ...
                        <div class="d-flex justify-content-end" data-kt-product-table-toolbar="base"
                            ...
                            <!--end::Filter-->
                            <!--begin::Add product-->
                            <a href="{{route('user.product.create')}}" class="btn btn-primary">Add
                                Product</a>
                            <!--end::Add product-->
                        </div>
                        <!--end::Toolbar-->
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3" data-bs-toggle="modal"
                                                data-bs-target="#kt_modal_create_order"
                                                onclick="addProductsToOrderModal('create_order_table_body', `{{$product->asin}}`)">Create
                                                Order</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3" data-bs-toggle="modal"
                                                data-bs-target="#kt_modal_create_shipment"
                                                onclick="addProductsToShipmentModal('create_shipment_table_body', `{{$product->asin}}`)">Send
                                                to warehouse</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3"
                                                onclick="deleteTableRow(`{{route('user.product.delete',$product->id)}}`, `{{$index}}`)"
...
@include('user.product.modals.create_order_modal')
@include('user.product.modals.create_shipment_modal')
@stop
...
<script src="{{asset('js/custom/apps/product/index.js')}}"></script>
<script src="{{asset('js/custom/apps/product/create-order.js')}}"></script>
<script src="{{asset('js/custom/apps/product/create-shipment.js')}}"></script>
