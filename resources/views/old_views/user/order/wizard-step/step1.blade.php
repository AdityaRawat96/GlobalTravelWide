                                ...
                                <div class="d-flex mt-3">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <div class="badge-container mt-2">
                                            @if(isset($product['incoming_product']['remaining_qty']) &&
                                            $product['incoming_product']['remaining_qty'] > 0)
                                            <span class="badge py-3 px-4 fs-7 badge-light-warning">
                                                {{$product['incoming_product']['remaining_qty']}}
                                                Item{{$product['incoming_product']['remaining_qty'] > 1 ? 's' : ''}}
                                                remaining.
                                            </span>
                                            @endif
                                        </div>
