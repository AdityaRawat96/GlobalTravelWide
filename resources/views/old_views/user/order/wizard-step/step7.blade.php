...
<div class="{{$currentStep == 7 ? 'current' : ''}}" data-kt-stepper-element="content">
    ...
    <div class="card py-4" style="position: relative; width: 100%;">
        ...
        <div class="card-body pt-0">
            <div class="w-100">
                <!--begin::Subheading-->
                <div class="text-muted fw-semibold fs-3 mt-8">Your Order ID is - <b>{{$order_id_generated}}</div>
                <!--end::Subheading-->
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <form class="form" id="tracking_info_form">
                            ...
                            <div class="fv-row">
                                ...
                                <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Select carrier" name="tracking_carrier" wire:model="tracking_info.carrier_id" id="tracking_carrier">
                            ...
                            <div class="fv-row mt-5">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="" name="tracking_id" wire:model="tracking_info.tracking_id" style="text-transform:uppercase" />
                                <!--end::Input-->
                            </div>
                            <!-- end::Input group-->
                            <div class="d-flex flex-rows justify-content-end mt-5">
                                <button class="btn btn-danger mx-1" type="button" wire:click="toggleTrackingForm(false)">
                                    Cancel
                                </button>
                                <button type="button" id="set_tracking_submit" class="btn btn-success mx-1" onclick="setTrackingInfo()">
                        ...
                        <div class="d-flex flex-row">
                            ...
                            <div class="address-copy-container">
                                <div class="ship_from_address_tooltip">
                                    <button type="button" class="btn btn-primary" onclick="tooltipMouseIn('ship_from_address_tooltip_text_3')" onmouseout="tooltipMouseOut('ship_from_address_tooltip_text_3')">
                        ...
                        @endif
                        <br><br>
                        <a href="{{route('user.order.view', $order_id)}}">
                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <div class="text-center px-4 py-15">
                            <img src="{{asset('media/illustrations/jolly/Working with papers.svg')}}" alt="" class="mw-100 mh-300px" />
                        </div>
                        <!--end::Illustration-->
                    </div>
                </div>
