 ...
 <div class="aside-column">
             ...
             <div class="d-flex flex-column gap-10">
                 <div class="add-product-container">
                     ...
                     <div class="product-image-container mt-3">
                         <div class="image-input image-input-empty image-input-placeholder mb-3"
                     ...
                     <div class="row mb-3 mt-5">
                         <div class="col-12">
                             ...
                             <button type="button" class="btn btn-danger form-control"
                                 wire:click="discardProductChanges()">
             ...
             <div class="d-flex flex-column gap-10">
                 <div class="add-product-container">
                     ...
                     <div class="product-image-container">
                         <div class="image-input image-input-empty image-input-placeholder-output mb-3"
                             data-kt-image-input="true">
                             <div class="image-input-wrapper w-150px h-150px"></div>
                         </div>
                     </div>
                     ...
                     <div class="row mb-3 mt-5">
                         <div class="col-12">
                             ...
                             <!--begin::Button-->
                             <button type="button" class="btn btn-danger form-control"
                                 wire:click="clearOutgoingProduct()">
                                 <span class="indicator-label">Discard Changes</span>
                             </button>
                             <!--end::Button-->
                             @endif
     ...
     <div class="card card-flush py-4 mb-5">
         ...
         <div class="card-header">
             ...
             <div class="card-actions pt-5">
                 <button type="button" wire:click="setCurrentStep(1)"
                     class="float-right btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                     ...
                                     <label class="d-flex flex-stack mb-5 cursor-pointer">
                                         ...
                                         <span class="d-flex align-items-center me-2">
                                             ...
                                             <div class="symbol symbol-45px me-4">
                                                 @if($carrier['logo'])
                                                 <img src="{{Storage::disk('s3')->url($carrier['logo'])}}"
                                         ...
                                         <span class="fv-row form-check form-check-custom form-check-solid">
                                             <input class="form-check-input carrier_radio d-block" type="radio"
                                                 name="carrier" value="{{$carrier_id}}" wire:model="carrier_selected"
                                                 wire:change="updateServices()" />
                                         </span>
                                         <!--end:Input-->
                                     </label>
                                 </div>
     ...
     <div class="card card-flush py-4 mb-5">
         ...
         <div class="card-header">
             ...
             @if($currentStep == 6)
             <div class="card-actions pt-5">
                 <button type="button" wire:click="setCurrentStep(2)"
                     class="float-right btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                     <!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
                     <span class="svg-icon svg-icon-3">
                         <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 ...
                                 <label class="d-flex flex-stack mb-5 cursor-pointer">
                                     ...
                                     <span class="d-flex align-items-center me-2">
                                         ...
                                         <div class="symbol symbol-45px me-4">
                                             ...
                                             <img src="{{Storage::disk('s3')->url($carriers[$carrier_selected]['logo'])}}"
                                                 alt="carrier logo" class="img-fluid">
                                             @else
                                             <span class="symbol-label bg-primary">
                                                 <i class="text-inverse-primary fs-1 lh-0 fonticon-delivery"></i>
     ...
     <div class="card card-flush py-4 mb-5">
         ...
         <div class="card-header">
             ...
             @if($currentStep == 6)
             <div class="card-actions pt-5">
                 <button type="button" wire:click="setCurrentStep(4)"
                     class="float-right btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                     <!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
                     <span class="svg-icon svg-icon-3">
                         <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
     ...
     <div class="card card-flush py-4 mb-5">
         ...
         <div class="card-header">
             ...
             @if($currentStep == 6)
             <div class="card-actions pt-5">
                 <button type="button" wire:click="setCurrentStep(5)"
                     class="float-right btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                     <!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
                     <span class="svg-icon svg-icon-3">
                         <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
