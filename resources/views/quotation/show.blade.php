        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <h1 class="page-heading d-flex fw-bold fs-3 flex-column justify-content-center my-0">
                    {{ str_pad($quotation->quotation_id, 5, '0', STR_PAD_LEFT) }}
                </h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                ...
                <div class="flex-xxl-row-fluid mb-10 mb-xxl-0 me-xxl-7 me-xxxl-10">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-12">
                            @include('pdf.quotation', ['quotation' => $quotation, 'quotation_airlines' =>
                            $quotation_airlines,
                            'quotation_hotels' => $quotation_hotels, 'view' => true])
                        </div>
                        <!--end::Card body-->
                    </div>
                    <!--end::Card-->
                            ...
                            <div class="mb-10">
                                ...
                                <div class="form-group fv-row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <!--end::Dropzone-->
                                        @if(count($quotation_attachments) == 0)
                                        <!--begin::Hint-->
...
<script src="{{asset('js/quotation/show.js')}}"></script>
