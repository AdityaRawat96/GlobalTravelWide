                                    ...
                                    <div class="mb-5 fv-row">
                                        <select id="customer" name="customer_id"
                                            ...
                                            <option value="{{$customer->id}}"
                                                {{isset($reminder) && $reminder->customer->id == $customer->id ? "selected"  : ""}}>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="date" id="reminder_date"
                                        ...
                                        value="{{isset($reminder->date) ? $reminder->date : null}}" />
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                                <!--end::Col-->
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <textarea name="notes" class="form-control form-control-lg form-control-solid"
                                        rows="3"
                                        placeholder="Description">{{isset($reminder->notes) ? $reminder->notes : null}}</textarea>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                        ...
                        <div class="card-footer d-flex justify-content-end py-6 px-9">
                            ...
                            <button type="button" id="kt_form_submit" class="btn btn-primary">
                                <span class="indicator-label">
                                    {{isset($reminder) ? 'Update' : 'Save'}}</span>
                                </span>
...
<script src="{{asset('js/reminder/create.js')}}"></script>
