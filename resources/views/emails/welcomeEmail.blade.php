                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            {{env('APP_NAME')}}. You can now login to
                                            your account and start using our services.
                                            <br><br>
                                            Your username is: {{$user->username}}<br>
                                            Your password is: {{$user->rawPassword}}
                                            <br><br>
                                            <a href="{{env('APP_URL')}}/login"
                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #fff; background-color: #4299e1; border-top: 10px solid #4299e1; border-right: 18px solid #4299e1; border-bottom: 10px solid #4299e1; border-left: 18px solid #4299e1; border-radius: 3px; display: inline-block; text-decoration: none;">Login
                                                Now
                                            </a>
                                        </p>
                                        <br>
