        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                    {{isset($refund) ? "Update" : "Create" }} Refund
                </h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="{{'/' . Auth::user()->role . '/refund/' . $refund->id}}" class="btn btn-sm fw-bold btn-danger"
                    id="delete-refund">Delete</a>
                ...
                <div class="flex-xxl-row-fluid mb-10 mb-xxl-0 me-xxl-7 me-xxxl-10">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-12">
                            <!--begin::Form-->
                            <form class="form"
                                action="{{isset($refund) ? route(Auth::user()->role . '.refund.update', $refund->id) : route(Auth::user()->role . '.refund.store')}}"
                                id="kt_create_form" method="{{isset($refund) ? 'PUT' : 'POST'}}"
                                ...
                                <div class="d-flex flex-column align-items-start flex-xxl-row">
                                    ...
                                    <div class="fv-row fw-row me-4 order-2">
                                        <div class="d-flex align-items-center flex-equal " data-bs-toggle="tooltip"
                                            data-bs-trigger="hover" title="Specify refund date">
                                            <!--begin::Date-->
                                            <div class="fs-6 fw-bold text-gray-700 text-nowrap required">Applied Date:
                                            </div>
                                            <!--end::Date-->
                                            <!--begin::Input-->
                                            <div class="position-relative d-flex align-items-center w-150px">
                                                ...
                                                <input class="form-control form-control-transparent fw-bold pe-5"
                                                    placeholder="Select date" name="refund_date"
                                                    value="{{isset($refund) ? (new DateTime($refund->refund_date))->format('d-M-Y') : date('d-M-Y')}}" />
                                                <!--end::Datepicker-->
                                                <!--begin::Icon-->
                                    ...
                                    <div
                                        ...
                                        <span class="fs-4 fw-bold text-gray-800">Refund #</span>
                                        <input type="text" name="refund_id" id="refund_id"
                                            class="form-control form-control-flush fw-bold text-muted fs-3 w-150px"
                                            value="{{isset($refund) ? $refund->refund_id : time() }}" disabled />
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                        ...
                                        <div class="d-flex align-items-center justify-content-end flex-equal"
                                            ...
                                            <div class="position-relative d-flex align-items-center w-150px">
                                                ...
                                                <input class="form-control form-control-transparent fw-bold pe-5"
                                                    ...
                                                    value="{{isset($refund) ? (new DateTime($refund->due_date))->format('d-M-Y') : null}}" />
                                                <!--end::Datepicker-->
                                                <!--begin::Icon-->
                                                <!--begin::Svg Icon | path: icons/duotune/arrows/arr072.svg-->
                                ...
                                <div class="mb-0">
                                    ...
                                    <div class="row gx-10 mb-5">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="mb-5 fv-row">
                                                <input name="ref_number" type="text"
                                                    ...
                                                    value="{{isset($refund) ? $refund->ref_number : null}}" />
                                                <div class="fv-plugins-message-container invalid-feedback"></div>
                                            </div>
                                            <!--end::Input group-->
                                            <label
                                            ...
                                            <div class="mb-5 fv-row">
                                                <select name="company_id"
                                                    ...
                                                    <option value="{{$company->id}}"
                                                        {{isset($refund) && $refund->company_id == $company->id ? "selected"  : ""}}>
                                                        {{$company->name}}
                                                    </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="mb-5 fv-row">
                                                <select id="customer" name="customer_id"
                                                    ...
                                                    <option value="{{$customer->id}}"
                                                        {{isset($refund) && isset($refund->customer) && $refund->customer->id == $customer->id ? "selected"  : ""}}>
                                            ...
                                            <!--end::Input group-->
                                            <div class="customer_details {{isset($refund) ? '' : 'd-none'}}">
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <input id="customer_email" type="text"
                                                        class="form-control form-control-solid"
                                                        value="{{isset($refund->customer) ? $refund->customer->email : null}}"
                                                ...
                                                <div class="mb-5">
                                                    <input id="customer_phone" type="text"
                                                        class="form-control form-control-solid"
                                                        value="{{isset($refund->customer) ? $refund->customer->phone : null}}"
                                    ...
                                    <div class="table-responsive mb-10">
                                        ...
                                        <table class="table g-5 gs-0 mb-0 fw-bold text-gray-700" data-kt-element="items"
                                            ...
                                            <tbody>
                                                @if(isset($refund))
                                                @foreach($refund_products as $index => $refund_product)
                                                        ...
                                                        <div class="mb-5 fv-row">
                                                            <select name="product[{{ $index  }}]"
                                                                ...
                                                                <option value="{{$product->id}}"
                                                                    {{$product->id == $refund_product->catalogue_id ? 'selected' : ''}}>
                                    ...
                                    <div class="table-responsive mb-10">
                                        ...
                                        <table class="table g-5 gs-0 mb-0 fw-bold text-gray-700"
                                            ...
                                            <tbody>
                                                @if(isset($refund))
                                                @foreach($refund_payments as $index => $refund_payment)
                                                    ...
                                                    <td class="pe-7">
                                                        ...
                                                        <div class="mb-5 fv-row">
                                                            <select name="payment_mode[{{ $index  }}]"
                                                                ...
                                                                <option value="bank"
                                                                    {{$refund_payment->mode == 'bank' ? 'selected' : ''}}>
                                                                    Bank Payment</option>
                                                                <option value="cash"
                                                                    {{$refund_payment->mode == 'cash' ? 'selected' : ''}}>
                                                                    Cash Payment</option>
                                                                <option value="other"
                                                                    {{$refund_payment->mode == 'other' ? 'selected' : ''}}>
                                                                    Other</option>
                                                            </select>
                                                            <div class="fv-plugins-message-container invalid-feedback">
                                                            </div>
                                                    ...
                                                    <td class="ps-0">
                                                        <div class="mb-5 fv-row">
                                                            <input class="form-control form-control-solid"
                                                                ...
                                                                value="{{(new DateTime($refund_payment->date))->format('d-M-Y')}}"
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <textarea name="notes" class="form-control form-control-solid" rows="3"
                                            placeholder="Thanks for your business">{{isset($refund) ? $refund->notes : null}}</textarea>
                                    </div>
                                    <!--end::Notes-->
                                </div>
                                <!--end::Wrapper-->
