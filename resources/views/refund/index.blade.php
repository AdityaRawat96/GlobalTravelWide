                    ...
                    <div class="d-flex flex-stack mb-5 table-toolbar">
                        ...
                        <div class="table-search d-flex align-items-center position-relative my-1">
                            ...
                            <span class="svg-icon svg-icon-1 position-absolute ms-6">
                                <svg width="24" height="24" viewRefund="0 0 24 24" fill="none"
                        ...
                        <div class="d-flex justify-content-end gap-2" data-kt-docs-table-toolbar="base">
                                    ...
                                    <div class="px-7 py-5">
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <div>
                                                <select class="form-select form-select-solid filter-option"
                                                    data-kt-select2="true" data-placeholder="Select option"
                                                    data-filter-target="refund_date" data-filter-type="date"
                                                    data-dropdown-parent="#table_filter" data-allow-clear="true">
                                                    <option></option>
                                                    <option value="<=,{{date('Y-m-d')}}">Past Refunds</option>
                                                    <option value=">,{{date('Y-m-d')}}">Future Refunds</option>
                                                </select>
                                            </div>
                                            <!--end::Input-->
                                        </div>
                            ...
                            <div id="kt_datatable_export_menu"
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{route(Auth::user()->role . '.refund.export', 'excel')}}"
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{route(Auth::user()->role . '.refund.export', 'csv')}}"
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{route(Auth::user()->role . '.refund.export', 'pdf')}}"
                            ...
                            <!--end::Export dropdown-->
                            <!--begin::Add Record -->
                            <a href="{{route(Auth::user()->role . '.refund.create')}}">
                                <button type="button" class="btn btn-primary">Add Refund</button>
                            </a>
                            <!--end::Add Record -->
                        </div>
                        <!--end::Toolbar-->
